        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('termins.update', $termin->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                                ...
                                <select class="form-control @error('period_id') is-invalid @enderror"
                                    ...
                                    @foreach ($periodes as $periode)
                                        <option value="{{ $periode->id }}"
                                            {{ old('period_id', $termin->period_id) == $periode->id ? 'selected' : '' }}>
                                            {{ $periode->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('termin_number') is-invalid @enderror"
                                       id="termin_number" name="termin_number"
                                       value="{{ old('termin_number', $termin->termin_number) }}"
