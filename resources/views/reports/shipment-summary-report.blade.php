    ...
    <div class="container">
        <div class="page-inner">
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                <div>
                    <h3 class="fw-bold mb-0">Shipment Summary Report</h3>
                    <p class="text-muted mb-0">Overview of shipment performance and status</p>
                </div>
            </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <form id="filterForm" method="GET" action="{{ route('shipment.summary') }}">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-2 d-flex align-items-end">
                                <a href="{{ route('shipment.summary') }}" class="btn btn-secondary w-100">
