    ...
    <div class="container">
        <div class="page-inner">
            ...
            <style>
                ...
                #shipmentTable .table tbody tr {
                    height: 20px !important;
                }

                /* Hilangkan spacing tambahan */
                #shipmentTable .table tbody td .badge,
                #shipmentTable .table tbody td i,
                #shipmentTable .table tbody td .btn {
                    margin: 0 !important;
                                ...
                                <tbody>
                                    @forelse ($shipments as $shipment)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($shipment->completion_date)->format('d M Y') }}
                                            </td>
                                            <td><span
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="{{ route('shipments.upload.documents', $shipment->id) }}"
                        ...
                        <div class="card shadow-sm mb-3">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled small mb-0">
                                    ...
                                    <li class="mb-1"><strong>Vessel:</strong>
                                    ...
                                    <li class="mb-1"><strong>Volume:</strong>
                                        {{ number_format($shipment->volume, 0, ',', '.') }} Liter</li>
                                    <li><strong>Filling Date:</strong>
                                        {{ \Carbon\Carbon::parse($shipment->completion_date)->format('d M Y') }}</li>
                                </ul>
                            </div>
                        </div>
                    @empty
