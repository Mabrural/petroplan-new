        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('upload-shipment-documents.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="attachments[]" id="attachments" class="form-control @error('attachments.*') is-invalid @enderror" accept=".pdf,.png,.jpg,.jpeg,.heic" multiple required>
                                <small class="text-muted">Allowed formats: PDF, PNG, JPG, JPEG, HEIC. Max 20MB per file.</small>
                                @error('attachments.*')
